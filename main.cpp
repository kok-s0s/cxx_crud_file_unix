...
TEST(iniFile_Test, getStringFromIni) {
  ...
  if (fileTools.iniSetup(ini_test_01)) {
...
TEST(iniFile_Test, getFloatFromIni) {
  ...
  if (fileTools.iniSetup(ini_test_01)) {
    ...
    fileTools.getFromIni(ini_test_01, "float", "float1", float_value_01,
                         22.09f);
    fileTools.getFromIni(ini_test_01, "float", "float2", float_value_02,
                         22.09f);
    fileTools.getFromIni(ini_test_01, "float", "float3", float_value_03,
                         22.09f);
...
TEST(iniFile_Test, getArrayIntFromIni) {
  ...
  if (fileTools.iniSetup(ini_test_01)) {
    ...
    fileTools.getFromIni(ini_test_01, "array", "arrayInt_testD",
